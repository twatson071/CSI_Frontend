...
function createTestDatabase() {
    var sqlite = new (require('better-sqlite3'))(':memory:');
    var db = (0, better_sqlite3_1.drizzle)(sqlite, { schema: schema });
    // Run migrations or create tables
    // You might need to adjust this based on your migration setup
    return { db: db, sqlite: sqlite };
}
// Helper to create test user
function createTestUser(db_1) {
    return __awaiter(this, arguments, void 0, function (db, userData) {
        var defaultUser;
        if (userData === void 0) { userData = {}; }
        return __generator(this, function (_a) {
            defaultUser = __assign({ email: 'test@example.com', name: 'Test User', role: 'user' }, userData);
...
function cleanupTestDatabase(sqlite) {
    sqlite.close();
}
