    ...
    hooks: {
            ...
            return __generator(this, function (_a) {
                if (ctx.path === "/sign-up/email") {
                    ...
                    if (!email.endsWith(".mil")) {
                        return [2 /*return*/, ctx.json({ message: "Email must end with .mil" }, { status: 400 })];
                    }
                }
                return [2 /*return*/];
            });
        ...
        after: function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(ctx.path === "/sign-up/email" && ((_a = ctx.returned) === null || _a === void 0 ? void 0 : _a.user))) return [3 /*break*/, 2];
