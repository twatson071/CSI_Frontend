...
exports.waitForDatabase = exports.initializeDatabase = void 0;
var bun_sqlite_1 = require("bun:sqlite");
var bun_sqlite_2 = require("drizzle-orm/bun-sqlite");
var schema = require("./schema");
var initializeDatabase = function (dbPath) {
    console.log("Opening database: ".concat(dbPath));
    try {
        var sqlite = new bun_sqlite_1.Database(dbPath);
        // Check if tables exist
        var tables = sqlite.prepare("SELECT name FROM sqlite_master WHERE type='table'").all();
        if (tables.length === 0) {
        ...
        console.log("\u2705 Database initialized with ".concat(tables.length, " tables"));
 ...
 */
var waitForDatabase = function (dbPath_1) {
    var args_1 = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args_1[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([dbPath_1], args_1, true), void 0, function (dbPath, maxRetries) {
        var i, sqlite, tables;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        ...
                        tables = sqlite.prepare("SELECT COUNT(*) as count FROM sqlite_master WHERE type='table'").get();
                        sqlite.close();
                        if (tables.count > 0) {
